...
<body>
	...
	<fieldset>
		...
		<table>
			<tr>
				<th>ID:<input type="text" name="id"></th></tr>
...
<?php
    ...
    {
        $id=$_POST['id'];
          $query = "UPDATE `form4`  SET  iname='$_POST[iname]', cname='$_POST[cname]', Adhno='$_POST[Adhno]', distric='$_POST[distric]', imandal='$_POST[imandal]',iaddress='$_POST[iaddress]' where id=$_POST[id]";
