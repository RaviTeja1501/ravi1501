...
<div id="login-popup">
	...
	<fieldset>
		...
		<table>
			<tr><th>ID:<input type="text" name="id" class="search"></th></tr>
          <tr>
				<th>PassType</th><th><select name="selc5" required><option>---select--</option>
                ...
                <tr>
		          ...
		          <tr>
		          	<th>chalannumber</th><th><input type="text" name="Chalannumber"></th>
		          </tr>
...
<?php
    ...
    {
        $id=$_POST['id'];
          $query = "UPDATE `form3`  SET  selc5='$_POST[selc5]', place1='$_POST[place1]', place2='$_POST[place2]', dob1='$_POST[dob1]', dob2='$_POST[dob2]',Chalannumber='$_POST[Chalannumber]' where id=$_POST[id]";
