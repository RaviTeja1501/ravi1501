...
<div id="login-popup">
	...
	<fieldset>
		...
		<table>
			<tr><th>PassType</th><th><select name="selc5" required><option>---select--</option>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$dob2=$_POST['dob2'];
		$amount=$_POST['amount'];
		$query ="INSERT INTO  `form3`   (`selc5`,`place1`,`place2`,`dob1`,`dob2`,`amount`) VALUES ('$selc5','$place1','$place2','$dob1','$dob2','$amount')";
